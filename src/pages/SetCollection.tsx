...
import { useGetCollectionsByOwnerAddress } from "exclusuive-typescript-sdk";
...
const SetCollectionPage = () => {
  ...
  const { collections, isPending } = useGetCollectionsByOwnerAddress({
    owner: user?.address || "",
  });
              ...
              return (
                <li key={col.id}>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img
                        src={col.configs?.img_url}
                        alt="collection"
                        className="h-10 w-10 rounded-full"
                      />
                      <div>
                        <div className="text-sm font-bold text-[#474747]">{col.name}</div>
                        <div className="text-sm text-[#636363]">{col.configs?.description}</div>
                      </div>
                    </div>
                  </button>
                </li>
